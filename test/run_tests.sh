...
# first dry run
snakemake -np annotate_summary find_amr_vag panfeed map_back manhattan_plots heritability enrichment enrichment_plots qq_plots tree --cores 8 --use-conda --conda-frontend mamba
# actual run (brace yourself)
snakemake -p annotate_summary find_amr_vag panfeed map_back manhattan_plots heritability enrichment enrichment_plots qq_plots tree --cores 8 --use-conda --conda-frontend mamba
