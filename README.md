...
to install each environment:
    ...
    snakemake -p annotate_summary panfeed map_back manhattan_plot heritability enrichment enrichment_plots qq_plots tree --cores 24 --use-conda --conda-frontend mamba
